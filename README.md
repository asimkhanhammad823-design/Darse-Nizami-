...
- **Username + password login** — the admin panel's Users page generates (or
  lets you set) a username and password for each student and admin. Deleting
  a user or changing their credentials takes effect immediately.
- **One landing page** at the worker root (`/`) — a single page with the app
  download button and the login form; admins log in there and land in the
  panel, students download the app from the same page.
